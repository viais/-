...
void OLED_xx()
{
//	 float Distance = CSB_Run();
//	Time.us=0;
	int SZLK=0;
	  	OLED_ShowChinese(1, 5, "距离：");	
		  OLED_ShowChinese(1, 25, "十字路口：");	
	  	OLED_ShowSignedNum(72, 25, SZLK, 2, OLED_8X16);
//      OLED_ShowFloatNum(50, 5,Distance , 3, 2, OLED_8X16);
	    OLED_ShowString(105, 5, "cm", OLED_8X16);
	  	OLED_ShowChinese(105, 25, "个");	
      OLED_Update();
	    delay_ms(100);		
}
